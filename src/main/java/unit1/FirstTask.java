...
public class FirstTask {
    ...
    static String getMonthName(int monthOrder, String language) {
        ...
        switch (monthOrder) {
            case 1:
                month = (language == "en" ? "January" : "Январь");
                break;
            case 2:
                month = (language == "en" ? "February" : "Февраль");
                break;
            case 3:
                month = (language == "en" ? "March" : "Март");
                break;
            case 4:
                month = (language == "en" ? "April" : "Апрель");
                break;
            case 5:
                month = (language == "en" ? "May" : "Май");
                break;
            case 6:
                month = (language == "en" ? "June" : "Июнь");
                break;
            case 7:
                month = (language == "en" ? "July" : "Июль");
                break;
            case 8:
                month = (language == "en" ? "August" : "Август");
                break;
            case 9:
                month = (language == "en" ? "September" : "Сентябрь");
                break;
            case 10:
                month = (language == "en" ? "October" : "Октябрь");
                break;
            case 11:
                month = (language == "en" ? "November" : "Ноябрь");
                break;
            case 12:
                month = (language == "en" ? "December" : "Декабрь");
                break;
            default:
                month = (language == "en" ? "Unknown Month" : "Неизвестный месяц");
        }
        return month;
    }
}
